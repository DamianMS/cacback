...
catalogo = Catalogo(host='DamianMS.mysql.pythonanywhere-services.com', user='DamianMS', password='Hamerfall123', database='DamianMS$DBproof')
...
RUTA_DESTINO = '/home/DamianMS/mysite/static/imagenes'
